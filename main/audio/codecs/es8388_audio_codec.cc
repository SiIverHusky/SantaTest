...
Es8388AudioCodec::Es8388AudioCodec(void* i2c_master_handle, i2c_port_t i2c_port, int input_sample_rate, int output_sample_rate,
    ...
    duplex_ = true; // Whether it's full duplex
    input_reference_ = false; // Whether to use reference input for echo cancellation
    input_channels_ = 1; // Number of input channels
